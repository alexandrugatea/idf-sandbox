...
public class PersonCell extends AbstractCell<PersonJSO> {
	...
	public interface Template extends SafeHtmlTemplates {
		...
		@Template("<div class='person-cell {4}'>"
				 	+ "<header>"
				 		+ "<figure title='Name'>"
							...
							+ "</div>"
				 			...
				 			+ "</figcaption>"
						 + "</figure>"
						 + "<div class='floating-share floating-dial-bottom-left'>"
                              + "<button class='float-trigger float-btn'><i class='fa fa-link'></i></button>"
					...
					+ "</header>"
					+ "<section>"
						+ "<div class='personal-info parent-section' title='Personal Info'>"
							+ "<div class='race' title='Race'>{5}</div>"
							+ "<div class='language' title='Language'>{6}</div>"
						+ "</div>"
						+ "<div class='education parent-section' title='Education'>"
							+ "<div class='university' title='University'>{7}</div>"
						+ "</div>"
						+ "<div class='work parent-section' title='Work'>"
